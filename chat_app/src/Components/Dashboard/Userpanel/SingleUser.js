...
const SingleUser = React.memo(({ menu, name, setActive, activeChat, id, userID, setLoading }) => {
  ...
  const clickHandler = () => {
    ...
    setActive({ chatID: id, status: true, name: name });
  };
  return (
    <div style={{ width: "100%" }} onClick={clickHandler}>
      ...
      >
        <Badge
          ...
          badgeContent=" "
        >
          <Avatar src="https://img.icons8.com/color/48/000000/circled-user-male-skin-type-7--v2.png" />
        </Badge>
        <div style={{ width: "80%" }}>
